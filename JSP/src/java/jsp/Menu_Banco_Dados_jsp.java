 ...
 * @author Michel
 */
public class Menu_Banco_Dados_jsp extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql;
            sql = "SELECT usuario, senha FROM usuario_jsp where usuario = '"
                    + user + "' and senha='" + pass + "'";
        ...
        if (result){
            ...
            RequestDispatcher rd = request.getRequestDispatcher("menu_jsp");
